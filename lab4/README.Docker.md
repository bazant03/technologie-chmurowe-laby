...
Obraz można zbudować poleceniem np: docker build -t local/web100:v1.0.0 .
I uruchomić kontener poleceniem np: docker run -d --rm -p 8000:80 --name=web100 local/web100:v1.0.0
